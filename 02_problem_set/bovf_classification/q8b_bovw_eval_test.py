...
plt.grid(True)
plt.tight_layout()
plt.savefig("test_accuracy_vs_K.png")
plt.show()
print("Gráfico salvo em: test_accuracy_vs_K.png")
...
plt.tight_layout()
plt.savefig(f"test_confusion_matrix_K{best_K}.png")
plt.show()
print(f"Matriz de confusão salva em: test_confusion_matrix_K{best_K}.png")
